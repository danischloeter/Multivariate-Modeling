...
# ## 1- Load the Sales values of dataset “tute1.csv”. The purpose is to perform one-step ahead prediction on Sales value.
...
for i in range(3,101):
    #print(i)
    yhatmean=tute1.iloc[:i,1]
    #print(tute1.iloc[:i,1])
...
Yhatnaive=[]
for i in range(3,101):
    Yhatnaive.append(tute1.iloc[i-2,1])
len(Yhatnaive)
#Yhatnaive
...
Yhatdrift=[]
for i in range(3,101): 
    Yhatdrift.append((tute1.iloc[i-2,1]+(h*((tute1.iloc[i-2,1]-tute1.iloc[0,1])/(i-2)))))
len(Yhatdrift)
#Yhatdrift
...
plt.plot(obspred,Yhatmean,label='Predicted values for mean method',marker="*",markersize=30,color="purple")
plt.plot(obstrue,tute1.iloc[:,1],label='True values',marker="o",markersize=15,color="green")
...
plt.plot(obstrue,tute1.iloc[:,1],label='True value',marker="o",markersize=20,color="green")
...
resmean=tute1.iloc[2:,1]-Yhatmean
...
resnaive=tute1.iloc[2:,1]-Yhatnaive
...
resdrift=tute1.iloc[2:,1]-Yhatdrift
